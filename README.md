...
**Recipe Room** is a web app that uses the Spoonacular API to help users find recipes based on certain preferences and find ingredient substitutes when needed.
